...
WebUI.setText(findTestObject('Object Repository/Page_Create a new category  Categories  Fir_4c7a0c/input_name'), 'qwe')

WebUI.setText(findTestObject('Object Repository/Page_Create a new category  Categories  Fir_4c7a0c/textarea_notes'), 'ok')

WebUI.click(findTestObject('Object Repository/Page_Create a new category  Categories  Fir_4c7a0c/input_create_another'))

WebUI.uploadFile(findTestObject('Page_Create a new category  Categories  Firefly III/input_Attachments_attachments'), 'C:////Program Files////Git////LICENSE.txt')
